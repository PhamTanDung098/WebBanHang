            ...
            @endphp
              <tr>
                ...
                <td><span class="text-ellipsis">
                  ...
                  @endphp                 --}}
                  <a href="{{route('brand.active',$item->id)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                </span></td>
                <td>
                  <a href="" class="active" ui-toggle-class="">
                    <a href="{{route('brand.edit',$item->id)}}" ><i class="fas fa-edit edit"></i></a>
                    <a href="{{route('brand.delete',$item->id)}}"><i class="fas fa-trash-alt delete"></i></a>
                  </a>
                </td>
              </tr>
            @endforeach
